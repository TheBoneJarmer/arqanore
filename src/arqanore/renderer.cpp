...
arqanore::Matrix4 arqanore::Renderer::generate_view_matrix(arqanore::Camera &camera) {
...
arqanore::Matrix4 arqanore::Renderer::generate_projection_matrix(arqanore::Camera &camera, arqanore::Window *window) {
...
void arqanore::Renderer::render_model(arqanore::Window *window, arqanore::Model *model, arqanore::Vector3 position, arqanore::Quaternion rotation, arqanore::Vector3 scale, int frame) {
